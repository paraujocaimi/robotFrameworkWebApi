...
# Dress Menu
${Casual Dresses}       xpath://*[@id="block_top_menu"]/ul/li[2]/ul/li[1]/a
${Evening Dresses}      xpath://*[@id="block_top_menu"]/ul/li[2]/ul/li[2]/a
${Summer Dresses}       xpath://*[@id="block_top_menu"]/ul/li[2]/ul/li[3]/a

# Woman menu
${woman_categories}             xpath://*[@id="block_top_menu"]/ul/li[1]/ul[1]/li[1]/ul/li
